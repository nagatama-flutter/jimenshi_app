...
import 'generative_ai/generative_ai_cut_in.dart' as _i9;
import 'generative_ai/generative_ai_image.dart' as _i10;
import 'generative_ai/generative_ai_message.dart' as _i11;
import 'generative_ai/generative_ai_message_request.dart' as _i12;
import 'generative_ai/generative_ai_message_type.dart' as _i13;
import 'generative_ai/generative_ai_speech_audio.dart' as _i14;
...
class Protocol extends _i1.SerializationManagerServer {
  ...
  T deserialize<T>(
    ...
    if (t == _i9.GenerativeAICutIn) {
      return _i9.GenerativeAICutIn.fromJson(data) as T;
    }
    if (t == _i10.GenerativeAIImage) {
      return _i10.GenerativeAIImage.fromJson(data) as T;
    }
    if (t == _i11.GenerativeAIMessage) {
      return _i11.GenerativeAIMessage.fromJson(data) as T;
    }
    if (t == _i12.GenerativeAIMessageRequest) {
      return _i12.GenerativeAIMessageRequest.fromJson(data) as T;
    }
    if (t == _i13.GenerativeAIMessageType) {
      return _i13.GenerativeAIMessageType.fromJson(data) as T;
    }
    if (t == _i14.GenerativeAISpeechAudio) {
      return _i14.GenerativeAISpeechAudio.fromJson(data) as T;
    }
    ...
    if (t == _i1.getType<_i9.GenerativeAICutIn?>()) {
      return (data != null ? _i9.GenerativeAICutIn.fromJson(data) : null) as T;
    }
    if (t == _i1.getType<_i10.GenerativeAIImage?>()) {
      return (data != null ? _i10.GenerativeAIImage.fromJson(data) : null) as T;
    }
    if (t == _i1.getType<_i11.GenerativeAIMessage?>()) {
      return (data != null ? _i11.GenerativeAIMessage.fromJson(data) : null)
          as T;
    }
    if (t == _i1.getType<_i12.GenerativeAIMessageRequest?>()) {
      return (data != null
          ? _i12.GenerativeAIMessageRequest.fromJson(data)
          : null) as T;
    }
    if (t == _i1.getType<_i13.GenerativeAIMessageType?>()) {
      return (data != null ? _i13.GenerativeAIMessageType.fromJson(data) : null)
          as T;
    }
    if (t == _i1.getType<_i14.GenerativeAISpeechAudio?>()) {
      return (data != null ? _i14.GenerativeAISpeechAudio.fromJson(data) : null)
          as T;
    }
    if (t == _i1.getType<List<_i15.GenerativeAIMessage>?>()) {
      return (data != null
          ? (data as List)
    ...
    if (t == List<_i16.GenerativeAIConversation>) {
      return (data as List)
          .map((e) => deserialize<_i16.GenerativeAIConversation>(e))
          .toList() as dynamic;
    }
    if (t == List<_i17.GenerativeAIMessage>) {
      return (data as List)
          .map((e) => deserialize<_i17.GenerativeAIMessage>(e))
          .toList() as dynamic;
    }
    try {
  ...
  String? getClassNameForObject(Object? data) {
    ...
    if (data is _i9.GenerativeAICutIn) {
      return 'GenerativeAICutIn';
    }
    if (data is _i10.GenerativeAIImage) {
      return 'GenerativeAIImage';
    }
    if (data is _i11.GenerativeAIMessage) {
      return 'GenerativeAIMessage';
    }
    if (data is _i12.GenerativeAIMessageRequest) {
      return 'GenerativeAIMessageRequest';
    }
    if (data is _i13.GenerativeAIMessageType) {
      return 'GenerativeAIMessageType';
    }
    if (data is _i14.GenerativeAISpeechAudio) {
  ...
  dynamic deserializeByClassName(Map<String, dynamic> data) {
    ...
    if (data['className'] == 'GenerativeAICutIn') {
      return deserialize<_i9.GenerativeAICutIn>(data['data']);
    }
    if (data['className'] == 'GenerativeAIImage') {
      return deserialize<_i10.GenerativeAIImage>(data['data']);
    }
    if (data['className'] == 'GenerativeAIMessage') {
      return deserialize<_i11.GenerativeAIMessage>(data['data']);
    }
    if (data['className'] == 'GenerativeAIMessageRequest') {
      return deserialize<_i12.GenerativeAIMessageRequest>(data['data']);
    }
    if (data['className'] == 'GenerativeAIMessageType') {
      return deserialize<_i13.GenerativeAIMessageType>(data['data']);
    }
    if (data['className'] == 'GenerativeAISpeechAudio') {
      return deserialize<_i14.GenerativeAISpeechAudio>(data['data']);
    }
  ...
  _i1.Table? getTableForType(Type t) {
    ...
    switch (t) {
      ...
      case _i11.GenerativeAIMessage:
        return _i11.GenerativeAIMessage.t;
    }
    return null;
  }
